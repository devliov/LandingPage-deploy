...
import Photo5 from "../../../assets/Group 1mediaphoto.svg";
import Photo6 from "../../../assets/Group 4mediavideo.svg";
import Photo7 from "../../../assets/Group 1mediaphoto.svg";
import Photo8 from "../../../assets/Group 4mediavideo.svg";
...
export default function GalleryPhoto() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <b className="text-base">Galeria de Fotos</b>
      <div>
